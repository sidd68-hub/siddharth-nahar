...
"[project]/node_modules/@rive-app/canvas/rive.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
                ...
                var Rive = (()=>{
                    ...
                    return function(moduleArg = {}) {
                        ...
                        var $a, ab, eb = {
                            ...
                            486751: ()=>void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
                            486855: ()=>{
                                try {
                            ...
                            489903: (a)=>window.h.qa(a).L.sampleRate,
                            489976: (a)=>{
                                a = window.h.qa(a);
 ...
 */ var registerKeyboardInteractions = function(_a) {
                    ...
                    if (!canvas || !stateMachine || !rive || typeof window === "undefined") {
                        return null;
                    }
     ...
     */ Rive.prototype.setupRiveListeners = function(riveListenerOptions) {
                    ...
                    if (!this.shouldDisableRiveListeners) {
                        ...
                        var smWithFocusNodes = playingStateMachines.filter(function(sm) {
                            return sm.instance.hasFocusNodes();
                        }).map(function(sm) {
                            return sm.instance;
                        });
                        if (smWithFocusNodes.length) {
                            ...
                            this.keyboardEventCleanup = (0, _utils__WEBPACK_IMPORTED_MODULE_2__.registerKeyboardInteractions)({
                                canvas: this.canvas,
                                stateMachine: smWithFocusNodes[0],
                                rive: this.runtime,
...
//# sourceMappingURL=node_modules_%40rive-app_canvas_rive_0v3-ddg.js.map